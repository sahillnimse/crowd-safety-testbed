...
def generate_report_html(
    ...
    pct_right = summary.get("pct_moving_right", 0.0)
    pct_left = summary.get("pct_moving_left", 0.0)
    pct_h_right = summary.get("pct_heading_right", pct_right)
    pct_h_left = summary.get("pct_heading_left", pct_left)
...
<div class="container">
  ...
  <div class="kpi-grid">
    <div class="kpi-card left">
      <div class="kpi-label">Dominant Direction</div>
      <div class="kpi-val">{pct_left:.1f}% <span style="font-size: 16px; color: var(--left-color);">← Left</span></div>
      <div class="kpi-sub">vs {pct_right:.1f}% moving rightward</div>
    </div>
  ...
  <div class="section-card">
    ...
    <div class="dist-bar-wrap">
      <div class="dist-bar">
        <div class="dist-seg seg-left" style="width: {pct_left}%;" title="Leftward: {pct_left:.1f}%"></div>
        <div class="dist-seg seg-right" style="width: {pct_right}%;" title="Rightward: {pct_right:.1f}%"></div>
    ...
    <div class="legend-grid">
      <div class="legend-item"><div class="legend-dot seg-left"></div> <strong>Moving Left</strong>: {pct_left:.1f}% ({label_counts.get('person_moving_left', 0):,})</div>
      <div class="legend-item"><div class="legend-dot seg-right"></div> <strong>Moving Right</strong>: {pct_right:.1f}% ({label_counts.get('person_moving_right', 0):,})</div>
