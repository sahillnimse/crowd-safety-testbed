...
3. **Model Registry Integration**:
   All models are registered under [webapp/registry.py](file:///c:/Users/sahil/Downloads/Projects/crowd-safety-testbed/webapp/registry.py) and ready for immediate single-click benchmark runs in the web interface.
