...
MODELS_TO_CHECK = {
    ...
    # DM-Count density-map crowd metrics
    "dm_count_crowd": "models.dm_count.monitor",
}
...
EXTRA_LIB_CHECKS = {
    ...
    # DM-Count needs scipy only for peak extraction; cv2 provides the
    # fallback maximum filter, so a missing scipy is tolerated at runtime.
    "dm_count_crowd": ["cv2"],
}
